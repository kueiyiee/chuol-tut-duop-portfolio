...
Telegram: @Dagnachew Bezaredie`;
  ...
  return (
    <div
      id="cv-modal-overlay"
      className="fixed inset-0 z-50 bg-black/85 dark:bg-black/90 backdrop-blur-xl flex items-center justify-center p-1.5 sm:p-4 md:p-6 overflow-y-auto"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      <div
        id="cv-modal-window"
        className="relative w-[calc(100vw-0.5rem)] max-w-4xl h-[calc(100vh-0.75rem)] max-h-[100vh] flex flex-col rounded-2xl bg-white/95 dark:bg-[#060b18]/95 border border-slate-200 dark:border-blue-500/30 shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-2xl overflow-hidden transition-all duration-300 sm:h-auto sm:max-h-[94vh] sm:w-full"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modern Top Header / Glass Navigation Bar */}
        <div className="flex flex-col gap-2.5 px-2.5 py-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-5 sm:py-3.5 bg-slate-50/90 dark:bg-[#030712]/90 border-b border-slate-200 dark:border-blue-900/40 backdrop-blur-md">
          {/* Left: Scholar Identity & Official Seal */}
          <div className="flex items-center space-x-3 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-blue-500/10 dark:bg-blue-500/20 flex items-center justify-center border border-blue-500/30 text-blue-600 dark:text-sky-300 shadow-xs shrink-0">
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:space-x-2 sm:space-y-0">
            {/* Page View Tabs */}
            <div className="flex items-center justify-between bg-black/5 dark:bg-black/40 p-1 rounded-lg border border-slate-200 dark:border-blue-900/40 text-xs w-full sm:w-auto">
              <button
                type="button"
                onClick={() => setActiveTab('all')}
                className={`flex-1 px-2 py-1 rounded-md text-[10px] sm:text-[11px] font-medium transition-all cursor-pointer ${
                  activeTab === 'all'
            ...
            <div className="flex items-center justify-between gap-2 sm:justify-end">
              ...
              <div
                className="inline-flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg bg-blue-500/10 dark:bg-blue-950/50 border border-blue-500/30 text-blue-600 dark:text-sky-300 text-[10px] sm:text-xs font-semibold backdrop-blur-md select-none"
                title="Official Verified Online CV"
              >
                <Globe className="w-3.5 h-3.5" />
                <span className="hidden sm:inline">Official Online CV</span>
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg bg-white dark:bg-blue-950/40 border border-slate-200 dark:border-blue-500/30 hover:bg-slate-50 dark:hover:bg-blue-900/40 text-[10px] sm:text-xs font-semibold text-slate-800 dark:text-slate-200 transition-all cursor-pointer shadow-xs"
        ...
        {/* CV Document Content */}
        <div className="flex-1 min-h-0 p-3 sm:p-6 md:p-10 lg:p-12 overflow-y-auto space-y-4 sm:space-y-6 md:space-y-8 text-left bg-slate-50/50 dark:bg-[#060b18] text-slate-800 dark:text-slate-100 text-[11px] sm:text-sm leading-relaxed font-sans">
              ...
              <div className="border-b border-slate-200 dark:border-blue-900/40 pb-5 space-y-3">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="w-14 sm:w-20 aspect-[3.5/4.5] rounded-lg overflow-hidden border border-slate-300 dark:border-blue-500/40 shadow-xs bg-slate-100 dark:bg-[#070d1e] shrink-0">
                      <img
                    ...
                    <div className="min-w-0">
                      <h1 className="text-[1.6rem] sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-white font-comic">
                        CHUOL TUT DUOP
                      </h1>
                      <p className="text-sm sm:text-base text-blue-600 dark:text-sky-400 font-medium">
                        Curriculum Vitae
                      </p>
                  ...
                  <div className="space-y-1 text-[10px] sm:text-xs font-mono text-slate-600 dark:text-slate-400">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <a href="tel:+251917491593" className="hover:underline text-slate-900 dark:text-white font-semibold break-all">
                        +251 917491593
                      </a>
                    </div>
                    <div className="flex flex-wrap items-center gap-1.5">
                      <Mail className="w-3.5 h-3.5 text-blue-600 dark:text-sky-400 shrink-0" />
                      <a href="mailto:nyuonjamestutduop@gmail.com" className="hover:underline text-slate-900 dark:text-white break-all">
                        nyuonjamestutduop@gmail.com
                      </a>
                    </div>
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <a 
                        ...
                        className="hover:underline text-blue-600 dark:text-sky-300 break-all"
                      >
          ...
          {/* Bottom Action Bar */}
          <div className="pt-6 border-t border-slate-200 dark:border-blue-900/40 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between text-xs">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-lg bg-white dark:bg-blue-950/40 border border-slate-200 dark:border-blue-500/30 text-slate-800 dark:text-slate-200 font-semibold text-xs transition-colors cursor-pointer hover:bg-slate-100 dark:hover:bg-blue-900/40 shadow-xs"
              >
              ...
              <button
                type="button"
                onClick={onClose}
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer shadow-xs"
              >
                <span>Close</span>
              </button>
            </div>
